...
def run_checks(
    ...
    from drskill.checks import budget, duplicates, filesystem, heuristics, injection, lockfile, mcp, mcp_injection, mcp_tools, plugin_spec, shadowing, skill_shell, spec  # noqa: F401
